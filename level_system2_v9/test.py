...
while running:
    ...
    if on_title_screen:
        ...
        if game_mode == "freeplay":
            ...
            # Keep positions similar to freeplay layout
            screen.blit(score_text, (SCREEN_WIDTH // 2 - score_text.get_width() // 2, SCREEN_HEIGHT // 2 - 10))
            screen.blit(highest_level_text, (SCREEN_WIDTH // 2 - highest_level_text.get_width() // 2, SCREEN_HEIGHT // 2 + 20))
            screen.blit(level_reached_text, (SCREEN_WIDTH // 2 - level_reached_text.get_width() // 2, SCREEN_HEIGHT // 2 + 50))
